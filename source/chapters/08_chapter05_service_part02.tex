...
\node[fill=white, inner sep=4pt, font=\small, align=center] at (deploygrp.north) {Развёртывание (Deployment)\\\texttt{if97-calculator-service} (\texttt{replicas: 2}, HPA 2--10)};
